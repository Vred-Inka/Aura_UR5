...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.InputTag_L2 = UGameplayTagsManager::Get()
		.AddNativeGameplayTag(FName("InputTag.L2"),
			FString("Input Tag for Left Trigger."));

	GameplayTags.InputTag_R2 = UGameplayTagsManager::Get()
		.AddNativeGameplayTag(FName("InputTag.R2"),
 ...
 */
	...
	FString("Incoming XP Data Attribute"));
 ...
 */
	...
	GameplayTags.Abilities_None = UGameplayTagsManager::Get()
		.AddNativeGameplayTag(FName("Abilities.None"),
		FString("No Ability"));
 ...
 */
	...
	.AddNativeGameplayTag(FName("Abilities.Fire.FireBlast"),
