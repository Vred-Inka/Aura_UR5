	...
	UAbilitySystemComponent* ASC, ULoadScreenSaveGame* SaveGame)
{
	...
	const FGameplayEffectSpecHandle SpecHandle = ASC->MakeOutgoingSpec(
		CharacterClassInfo->PrimaryAttributes_SetByCaller, 1.0f, EffectContextHandle);
...
void UAuraAbilitySystemLibrary::SetIsRadialDamageEffectParam(FDamageEffectParams& DamageEffectParams, bool bInIsRadial,
...
void UAuraAbilitySystemLibrary::SetSetDeathImpulseDirection(FDamageEffectParams& DamageEffectParams,
